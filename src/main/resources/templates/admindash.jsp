        ...
        <div class="main-content">
            <div class="dashboard-charts">
                <div class="dashboard-chart">
                    <!-- Chart 1: Number of Students -->
                    <canvas id="chart1" width="300" height="300"></canvas>
                </div>
                <div class="dashboard-chart">
                    <!-- Chart 2: Number of Faculty -->
                    <canvas id="chart2" width="300" height="300"></canvas>
                </div>
                <div class="dashboard-chart">
                    <!-- Chart 3: Number of HODs -->
            ...
            <div class="dashboard-elements">
                <div class="dashboard-element">
                    <!-- Element 1: Replace with content -->
                    <h3>Element 1</h3>
                    <p>This is some content.</p>
                </div>
                <div class="dashboard-element">
                    <!-- Element 2: Replace with content -->
                    <h3>Element 2</h3>
                    <p>More content here.</p>
                </div>
                <div class="dashboard-element">
                    <!-- Element 3: Replace with content -->
                    <h3>Element 3</h3>
...
// Function to make an AJAX request to get chart data
function fetchChartData() {
    fetch("/getChartData")
        .then(response => response.json())
        .then(data => {
            // Data received, create and update the charts
            const studentsChart = new Chart(document.getElementById("chart1").getContext("2d"), {
                type: 'pie',
                data: {
                    labels: data.map(entry => entry.label),
                    datasets: [{
                        data: data.map(entry => entry.value),
                        backgroundColor: ['#FF5733', '#33FF6B', '#336BFF','#ffff00'], // Colors for each segment
                    }]
                },
            });

            const facultyChart = new Chart(document.getElementById("chart2").getContext("2d"), {
                type: 'pie',
                data: {
                    labels: data.map(entry => entry.label),
                    datasets: [{
            ...
            const hodsChart = new Chart(document.getElementById("chart3").getContext("2d"), {
                type: 'pie',
                data: {
                    labels: data.map(entry => entry.label),
                    datasets: [{
...
// Call the function to fetch and display the charts
fetchChartData();
</script>
