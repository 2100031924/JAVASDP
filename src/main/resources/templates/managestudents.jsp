...
<div class="wrapper">
 ...
 <div class="main-content">
            ...
            <table>
                ...
                <tbody>
                    <!-- Use Thymeleaf each loop to populate student data from the server-side -->
