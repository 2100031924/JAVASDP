...
<div class="main-content add-hod-form">
            <h1>Add Course</h1>
            <form action="/addcourse" method="post"> <!-- Correct the action URL -->
                <input type="text" name="courseName" placeholder="Course Name">
                <input type="text" name="courseId" placeholder="CourseId">
                <input type="text" name="courseCoordinator" placeholder="Course Coordinator">
                <!-- Add more form fields for course data -->
